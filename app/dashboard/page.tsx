...
const menuCards = [
  { href: '/dashboard/lookup', title: 'Search by ID', desc: 'See who this profile was shared to, or who shared to this profile', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z' },
